...
export const IncidentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ipmsApp.incident.delete.question">
        <Translate contentKey="ipmsApp.incident.delete.question" interpolate={{ id: incidentEntity.id }}>
