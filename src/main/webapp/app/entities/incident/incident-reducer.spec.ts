...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './incident.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCIDENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_INCIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCIDENT actions', async () => {
      const expectedActions = [
        {
